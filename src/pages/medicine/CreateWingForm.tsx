...
import { createWing } from "../../features/wings/wingsApi";
...
const CreateWing = () => {
  ...
  const { loading, error } = useSelector((state: RootState) => state.wings);
  ...
  return (
    <div className="p-8">
      <h1 className="text-2xl dark:text-gray-300 font-bold mb-6">Create a new Wing</h1>
      <Formik
              ...
              {Object.keys(initialValues).map((key) => (
                <div key={key} className="mb-4">
                  ...
                  {key === "manufactureDate" || key === "expiryDate" ? (
                    ...
                    <Field name={key} className="w-full p-2 border dark:text-gray-300 rounded" />
                  )}
                  <ErrorMessage
                    name={key}
                    component="div"
