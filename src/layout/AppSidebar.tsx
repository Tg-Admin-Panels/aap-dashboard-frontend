...
const AppSidebar: React.FC = () => {
  ...
  const navItems: NavItem[] = [
    ...
    },
    {
      ...
      subItems: [...dynamicForm.map(form => ({ name: form.formName, path: `/forms/submissions/${form._id}`, pro: false, role: ["admin", "superadmin", "volunteer"] }))],
      role: ["admin", "superadmin", "volunteer"],
    },
    {
      icon: <WingIcon />,
      name: "Wing",
      subItems: [
        { name: "Create Wing", path: "/wing/add", pro: false, role: ["admin", "superadmin"] },
        { name: "All Wings", path: "/wing/list", pro: false, role: ["admin", "superadmin"] },
      ],
    ...
    },
    {
      ...
      name: "Visions",
      subItems: [
        { name: "Create Vision", path: "/visions/add", pro: false, role: ["admin", "superadmin"] },
        { name: "All Visions", path: "/visions/list", pro: false, role: ["admin", "superadmin"] },
      ],
      role: ["admin", "superadmin"],
    },
    {
      ...
      name: "Volunteers",
      subItems: [
        { name: "All Volunteers", path: "/volunteers/", pro: false, role: ["admin", "superadmin"] },
        { name: "Create Volunteer", path: "/volunteers/add", pro: false, role: ["admin", "superadmin"] },
      ],
      role: ["admin", "superadmin"],
    },
    {
    ...
    },
    {
      icon: <GroupIcon />,
      name: "Booth Team",
      subItems: [{ name: "All Booth Team", path: "/booth-team", pro: false, role: ["admin", "superadmin"] }],
      role: ["admin", "superadmin"],
    },
    {
      icon: <GridIcon />,
      name: "Locations",
      subItems: [
        { name: "Location Management", path: "/locations/states", pro: false, role: ["admin", "superadmin"] },
        { name: "Create State", path: "/locations/create-state", pro: false, role: ["admin", "superadmin"] },
        { name: "Create District", path: "/locations/create-district", pro: false, role: ["admin", "superadmin"] },
        { name: "Create Legislative Assembly", path: "/locations/create-assembly", pro: false, role: ["admin", "superadmin"] },
        { name: "Create Booth", path: "/locations/create-booth", pro: false, role: ["admin", "superadmin"] },
      ],
      role: ["admin", "superadmin"],
    },
    {
      ...
      subItems: [{ name: "All Applications", path: "/candidate-applications", pro: false, role: ["admin", "superadmin"] }],
      role: ["admin", "superadmin"],
    },
    {
      icon: <ChatIcon />,
      name: "Campaigns",
      subItems: [{ name: "All Campaigns", path: "/campaigns", pro: false, role: ["admin", "superadmin"] }],
      role: ["admin", "superadmin"],
    },
    {
      icon: <ListIcon />,
      name: "Data Fill",
      subItems: [
        { name: "Create Form", path: "/forms/create", pro: false, role: ["admin", "superadmin"] },
        { name: "All Forms", path: "/forms/list", pro: false, role: ["admin", "superadmin"] },
